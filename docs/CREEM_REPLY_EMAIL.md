...
Yi-API is an enterprise-grade AI API gateway service providing:
- Unified access to 30+ AI service providers (OpenAI, Anthropic, Google, etc.)
- Quota management and billing controls
- Channel load balancing and routing
- API relay and caching services

Our service operates on a prepaid quota system, processing payments via multiple gateways including Stripe, Creem, WeChat Pay, and Alipay.

### 🚀 Next Steps:

All compliance requirements have been fully implemented. Please re-review the account so we can proceed with enabling live payments via Creem.
...
1. **Before sending, get your Store ID:**
   - Log into Creem dashboard
   - Go to Business Settings (click profile picture)
   - Copy your store_id
